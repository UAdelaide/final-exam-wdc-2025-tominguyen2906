...
((SELECT dog_id FROM Dogs WHERE name = 'Chi'), '2025-05-10 09:30:00', 45, 'Beachside', 'accepted'),
...
((SELECT dog_id FROM Dogs WHERE name = 'Ales'), '2025-05-20 12:00:00', 40, 'Grassland', 'open');