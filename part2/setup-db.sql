...
('evewalker', 'eve@example.com', 'hashedxyz', 'walker');
...
((SELECT dog_id FROM Dogs WHERE name = 'Chi'), '2025-06-10 09:30:00', 45, 'Beachside Ave', 'accepted'),
...
((SELECT dog_id FROM Dogs WHERE name = 'Ales'), '2025-05-20 12:00:00', 40, 'Hilltop', 'open');